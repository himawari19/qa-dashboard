    ...
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.14),_transparent_30%),linear-gradient(180deg,#f8fafc_0%,#eef6fb_100%)] px-6 py-10">
      <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-6xl items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
        <section className="space-y-6">
          <div className="inline-flex items-center gap-2 rounded-md border border-sky-200 bg-white px-4 py-2 text-xs font-bold uppercase tracking-[0.22em] text-sky-700 shadow-sm">
        ...
        <section className="rounded-md border border-slate-200 bg-white p-8 shadow-xl">
          ...
          <form className="mt-8 space-y-4" onSubmit={submit}>
            <label className="block">
              ...
              <input
                ...
                className="h-12 w-full rounded-md border border-slate-200 px-4 text-sm outline-none focus:border-sky-500"
            ...
            <button
              disabled={pending}
              className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-md bg-sky-700 px-5 text-sm font-bold text-white transition hover:bg-sky-800 disabled:opacity-50"
            >
