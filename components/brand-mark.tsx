...
export function BrandMark({
 ...
 <span className={cn("text-sm font-black tracking-tight text-slate-900", titleClassName)}>QA Daily Hub</span>
 <span className={cn("mt-1 text-[11px] font-bold uppercase tracking-[0.32em] text-slate-500", subtitleClassName)}>
 Quality Ops
 </span>
 </div>
 )}
