...
export function CopyLinkButton({ module, itemId, activeTab }: CopyLinkButtonProps) {
  ...
  const handleCopy = useCallback(async () => {
    ...
    const url = shouldIncludeTab
      ? buildShareableUrlWithTab(window.location.origin, module, itemId, activeTab)
      : buildShareableUrl(window.location.origin, module, itemId);
