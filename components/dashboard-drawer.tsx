...
export function DashboardDrawer({ title, subtitle, items, loading, onClose, viewAllHref, entityType, entityId }: DashboardDrawerProps) {
 ...
 <div ref={ref} className="flex h-full w-full max-w-sm flex-col bg-white shadow-2xl animate-in slide-in-from-right duration-300">
 ...
 prefetch={false}
 onClick={onClose}
 className="group flex items-center gap-3 rounded-md border border-slate-100 p-3 transition hover:border-blue-200 hover:bg-blue-50/40"
 >
 ...
 prefetch={false}
 onClick={onClose}
 className="flex h-10 items-center justify-center gap-2 rounded-md bg-slate-900 text-sm font-bold text-white transition hover:bg-blue-600"
 >
