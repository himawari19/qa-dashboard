...
"Test Plan":"bg-indigo-100 text-indigo-700",
"Test Suite":"bg-emerald-100 text-emerald-700",
"Test Case":"bg-sky-100 text-sky-700",
"Test Session":"bg-cyan-100 text-cyan-700",
"Meeting Note":"bg-violet-100 text-violet-700",
 Sprint:"bg-orange-100 text-orange-700",
 Assignee:"bg-slate-100 text-slate-700",
