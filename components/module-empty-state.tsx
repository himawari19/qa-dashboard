      ...
      <td colSpan={colSpan} className="px-4 py-24 text-center">
        <div className="flex flex-col items-center gap-6">
          <div className="relative">
            ...
            <div className="relative flex h-24 w-24 items-center justify-center rounded-3xl bg-gradient-to-br from-gray-50 to-gray-100 text-gray-300 ring-1 ring-gray-200/60 shadow-sm">
              {hasActiveFilters ? (
          ...
          {!hasActiveFilters && canAdd && (
            <button
              type="button"
              onClick={onAdd}
              className="mt-2 inline-flex h-11 items-center gap-2  bg-gradient-to-r from-sky-500 to-blue-600 px-6 text-sm font-bold text-white shadow-md shadow-sky-500/20 transition-all  hover:shadow-lg hover:shadow-sky-500/30 active:translate-y-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2"
            >
