...
export function ModuleWorkspaceModals({
 ...
 <div className="relative w-full max-w-sm overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl animate-in zoom-in-95 duration-150">
 ...
 <div>
 <h3 className="text-sm font-black text-slate-900">Re-open Bug</h3>
 <p className="text-xs text-slate-400">Status will be set back to Open</p>
 </div>
 </div>
 ...
 className="flex-1 h-9 rounded-md border border-slate-200 text-xs font-bold text-slate-600 transition hover:bg-slate-50"
 >
 Cancel
 </button>
 <button
