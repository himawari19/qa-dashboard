...
"fixed inset-0 z-[200] flex items-center justify-center p-4 transition-all duration-300",
 ...
 <div className={cn(
"relative w-full max-w-sm transform overflow-hidden rounded-xl bg-white shadow-2xl transition-all duration-300 border border-slate-200",
...
"bg-blue-600"
 ...
 <h3 className="mb-1 text-base font-black text-slate-900">{title}</h3>
 <p className="text-xs font-medium leading-relaxed text-slate-500">{message}</p>
 </div>
 <div className="flex gap-2 px-6 pb-5">
 <button
 onClick={onCancel}
 className="flex-1 h-9 rounded-md border border-slate-200 bg-white text-xs font-bold text-slate-600 transition hover:bg-slate-50 active:scale-95"
 >
 {cancelText}
 </button>
 <button
